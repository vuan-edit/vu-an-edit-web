...
export const translations = {
  vi: {
    ...
    hero_sub: 'Khóa học edit video thực chiến từ creator Tình Báo Thị Trường & Người Quan Sát',
    hero_cta: 'Xem khóa học \u2192',
    hero_stats_views: '500M+',
    hero_stats_views_label: 'lượt xem',
    hero_stats_students: '50+',
    hero_stats_students_label: 'học viên',
    hero_stats_channels: '2',
    hero_stats_channels_label: 'kênh triệu view',

    // Social Proof
    social_proof_title: 'Creator đằng sau các kênh',
    social_proof_channel1: 'Tình Báo Thị Trường',
    social_proof_channel1_stat: '163M+ views \u2022 563K followers',
    social_proof_channel2: 'Người Quan Sát',
    social_proof_channel2_stat: '374M+ views \u2022 1.2M followers',

    // Testimonials
    testimonials_title: 'Học viên nói gì?',
    testimonial_1_name: 'Minh Tuấn',
    testimonial_1_role: 'Freelance Video Editor',
    testimonial_1_text: 'Sau khóa học, mình đã tự làm được video bản đồ chuyển động cho 3 khách hàng đầu tiên. Kiến thức thực chiến, không lý thuyết suông.',
    testimonial_2_name: 'Thu Trang',
    testimonial_2_role: 'Content Creator',
    testimonial_2_text: 'Anh An chỉ rất tận tình. Mình từ không biết gì về AE, giờ đã có thể dựng video với infographic và bản đồ chuyên nghiệp.',
    testimonial_3_name: 'Hoàng Long',
    testimonial_3_role: 'Kênh YouTube Kinh tế',
    testimonial_3_text: 'GEOLayers 3 là game-changer. Kênh mình tăng 40% watch time sau khi áp dụng kỹ thuật bản đồ đã học.',
    ...
    blog_cta_desc: 'Khóa học thực chiến 13 buổi (19 giờ) — từ After Effects, GEOLayers 3 đến viral content strategy.',
  ...
  en: {
    ...
    hero_sub: 'Hands-on video editing course from the creator of Tình Báo Thị Trường & Người Quan Sát',
    hero_cta: 'View course \u2192',
    hero_stats_views: '500M+',
    hero_stats_views_label: 'views',
    hero_stats_students: '50+',
    hero_stats_students_label: 'students',
    hero_stats_channels: '2',
    hero_stats_channels_label: 'million-view channels',

    social_proof_title: 'Creator behind the channels',
    social_proof_channel1: 'Tình Báo Thị Trường',
    social_proof_channel1_stat: '163M+ views \u2022 563K followers',
    social_proof_channel2: 'Người Quan Sát',
    social_proof_channel2_stat: '374M+ views \u2022 1.2M followers',
    ...
    testimonial_1_name: 'Minh Tuấn',
    testimonial_1_role: 'Freelance Video Editor',
    testimonial_1_text: 'After the course, I was able to create motion map videos for my first 3 clients. Practical knowledge, no fluff.',
    testimonial_2_name: 'Thu Trang',
    testimonial_2_role: 'Content Creator',
    testimonial_2_text: 'An is incredibly dedicated. I went from zero AE knowledge to creating professional infographic and map videos.',
    testimonial_3_name: 'Hoàng Long',
    testimonial_3_role: 'Economics YouTube Channel',
    testimonial_3_text: 'GEOLayers 3 is a game-changer. My channel\'s watch time increased 40% after applying the map techniques I learned.',
    ...
    blog_cta_desc: '13-session hands-on course (19 hours) — from After Effects, GEOLayers 3 to viral content strategy.',
